                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('category.update', [$category]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="category_title" type="text" class="form-control @error('category_title') is-invalid @enderror" value="{{ $category->title }}"name="category_title" required autocomplete>
